...
- [1. Basic Deployment](#1-basic-deployment)
  - [1.1. Prerequisites](#11-prerequisites)
  - [1.2. Portal Deployment](#12-portal-deployment)
  - [1.3. Sign in to Azure](#13-sign-in-to-azure)
  - [1.4. Create virtual machine](#14-create-virtual-machine)
- [2. Connect to virtual machine](#2-connect-to-virtual-machine)
  - [2.1. Install Docker](#21-install-docker)
  - [2.2. Install Web Application](#22-install-web-application)
- [3. Security Hardening](#3-security-hardening)
  - [3.1. Basic](#31-basic)
    - [3.1.1. Network Security Group (NSG)](#311-network-security-group-nsg)
  - [3.2. Moderate](#32-moderate)
    - [3.2.1. Web Application Firewall (WAF)](#321-web-application-firewall-waf)
    - [3.2.2. Configure Firewall](#322-configure-firewall)
    - [3.2.3. Ingest WAF Logs to Sentinel](#323-ingest-waf-logs-to-sentinel)
  - [3.3. Just In Time Access (JIT)](#33-just-in-time-access-jit)
- [4. Advanced](#4-advanced)
  - [4.1. Network Watcher](#41-network-watcher)
    - [4.1.1. Create a Network Watcher in the portal](#411-create-a-network-watcher-in-the-portal)
  - [4.2. Firewall](#42-firewall)
  - [4.3. DDOS Protection](#43-ddos-protection)
    - [4.3.1. Create a DDoS protection plan](#431-create-a-ddos-protection-plan)
    - [4.3.2. Enable DDoS protection for an existing virtual network](#432-enable-ddos-protection-for-an-existing-virtual-network)
